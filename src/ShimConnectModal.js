...
class ConnectForm extends Component {
  state = {
    username:
      privateLocalCreds.username || process.env.NEO4J_USERNAME || "neo4j",
    ...
    encrypted: _.isNil(privateLocalCreds.encrypted)
      ? false
      : privateLocalCreds.encrypted,
    errors: {
      host: null,
      port: null,
      username: null,
  ...
  inputUpdated = (event, data) => {
    ...
    if (name === "host" && value && value.match(/[/:#?&@]/)) {
      errors.host =
        "Host can only contain an IP address or hostname, no scheme (http) or port";
    } else {
        ...
        <Modal.Content>
          ...
          <Form>
            <Form.Field required>
              ...
              <Message visible={!_.isNil(this.state.errors.host)} warning>
                {this.state.errors.host}
              </Message>
            </Form.Field>
            ...
            <Form.Field required>
              ...
              <Form.Input
                ...
                placeholder="Port"
              />
              <Message visible={!_.isNil(this.state.errors.port)} warning>
                {this.state.errors.port}
              </Message>
            </Form.Field>
            ...
            <Form.Field required>
              ...
              />
              <Message visible={!_.isNil(this.state.errors.username)} warning>
                {this.state.errors.username}
              </Message>
            </Form.Field>
            ...
            <Form.Field required>
              ...
              />
              <Message visible={!_.isNil(this.state.errors.password)} warning>
                {this.state.errors.password}
              </Message>
            </Form.Field>
